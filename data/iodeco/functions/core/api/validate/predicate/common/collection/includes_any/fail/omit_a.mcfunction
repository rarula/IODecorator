#> iodeco:core/api/validate/predicate/common/collection/includes_any/fail/omit_a
...
# 要素の表示を省略する
    execute store result score $Length IODecorator if data storage iodeco:core Args.includesAny[]
