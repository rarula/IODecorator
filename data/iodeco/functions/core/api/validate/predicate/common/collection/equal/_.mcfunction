#> iodeco:core/api/validate/predicate/common/collection/equal/_
...
# 検証に失敗 -> ArgumentError を発生させる
    execute if data storage iodeco:temp {Success:false} run function iodeco:core/api/validate/predicate/common/collection/equal/fail/_
