...
# エラーメッセージを設定する
    execute if data storage iodeco:core {Inverted:false} run data modify storage iodeco:util in.Message set value '{"color":"red", "translate":"Expected \'%1$s\' to be equal to \'[%2$s%3$s]\', but got \'[%4$s%5$s]\'.",  "with":[{"storage":"iodeco:", "nbt":"error.nbtName"}, {"storage":"iodeco:", "nbt":"error.detail.headA"}, {"storage":"iodeco:", "nbt":"error.detail.arrayAInfo", "interpret":true}, {"storage":"iodeco:", "nbt":"error.detail.headB"}, {"storage":"iodeco:", "nbt":"error.detail.arrayBInfo", "interpret":true}]}'
    execute if data storage iodeco:core {Inverted:true } run data modify storage iodeco:util in.Message set value '{"color":"red", "translate":"Expected \'%1$s\' not be equal to \'[%2$s%3$s]\', but got \'[%4$s%5$s]\'.", "with":[{"storage":"iodeco:", "nbt":"error.nbtName"}, {"storage":"iodeco:", "nbt":"error.detail.headA"}, {"storage":"iodeco:", "nbt":"error.detail.arrayAInfo", "interpret":true}, {"storage":"iodeco:", "nbt":"error.detail.headB"}, {"storage":"iodeco:", "nbt":"error.detail.arrayBInfo", "interpret":true}]}'
