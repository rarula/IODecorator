...
# 戻り値を設定する
    execute if data storage iodeco:core {Inverted:false} run data modify storage iodeco:core Predicate.minLength.success set value false
    execute if data storage iodeco:core {Inverted:false} run data modify storage iodeco:core Predicate.minLength.error set from storage iodeco:util out.Error
    execute if data storage iodeco:core {Inverted:true } run data modify storage iodeco:core Predicate.not.minLength.success set value false
    execute if data storage iodeco:core {Inverted:true } run data modify storage iodeco:core Predicate.not.minLength.error set from storage iodeco:util out.Error
