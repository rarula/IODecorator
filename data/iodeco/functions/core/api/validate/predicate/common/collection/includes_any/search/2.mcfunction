#> iodeco:core/api/validate/predicate/common/collection/includes_any/search/2
# @within function
...
# 値が一致するか、全てを探索し終えるまで再帰
    execute if data storage iodeco:temp {Result:true} if data storage iodeco:temp InputElements[0] run function iodeco:core/api/validate/predicate/common/collection/includes_any/search/2
