#> iodeco:core/api/validate/predicate/types/string/max_length/_
# @within function iodeco:core/api/validate/predicate/types/string/_

#>
# @within function iodeco:core/api/validate/predicate/types/string/max_length/**
...
# 検証に失敗 -> ArgumentError を発生させる
    execute if data storage iodeco:temp {Success:false} run function iodeco:core/api/validate/predicate/types/string/max_length/fail/_
