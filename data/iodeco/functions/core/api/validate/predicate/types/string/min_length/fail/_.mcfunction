#> iodeco:core/api/validate/predicate/types/string/min_length/fail/_
# @within function iodeco:core/api/validate/predicate/types/string/min_length/_
...
# 配列の長さを設定する
    ...
    execute if data storage iodeco:core {Inverted:true } store result storage iodeco:util in.Detail.length int 1.0 run scoreboard players remove $Length IODecorator 1
