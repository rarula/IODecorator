#> iodeco:core/api/validate/predicate/types/compound/empty/_
...
# 検証する
    data modify storage iodeco:temp Value set value {}
...
# 検証に失敗 -> ArgumentError を発生させる
    execute if data storage iodeco:temp {Success:false} run function iodeco:core/api/validate/predicate/types/compound/empty/fail/_
