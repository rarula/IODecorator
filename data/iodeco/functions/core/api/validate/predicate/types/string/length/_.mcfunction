#> iodeco:core/api/validate/predicate/types/string/length/_
# @within function iodeco:core/api/validate/predicate/types/string/_

#>
# @within function iodeco:core/api/validate/predicate/types/string/length/**
...
# 検証に失敗 -> ArgumentError を発生させる
    execute if data storage iodeco:temp {Success:false} run function iodeco:core/api/validate/predicate/types/string/length/fail/_
