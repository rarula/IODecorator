...
# エラーを発生させる
    ...
    data modify storage iodeco:util in.ExpectedType set value '{"storage":"iodeco:core", "nbt":"Error.detail.1[]", "separator":{"text":" | "}}'
    data modify storage iodeco:util in.Detail.1 set from storage iodeco: in.types
